...
const categories = ['todos', 'saquinho cyberchot']

const ProductCard = ({ product }) => {
  const productLink = `/variados/${product.id}`
      ...
      <div id="catalogo" className="space-y-12">
        <header className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <div className="space-y-1">
            ...
            <p className="text-zinc-500">Modelos feitos à mão, cada um com cuidado e propósito único.</p>
          </div>
