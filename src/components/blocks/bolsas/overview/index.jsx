                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {product.color.map((col) => (
                                <button
                                    key={col}
                                    className="rounded-full border border-zinc-200 px-5 py-2 text-sm font-medium transition-all hover:border-zinc-900 hover:bg-zinc-900 hover:text-white"
                                >
                                    {col}
                                </button>
                            ))}
                    ...
                    <div className="rounded-3xl border  p-6 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-y-4 text-sm">
                            ...
                            <div className="text-right font-bold ">{product.material}</div>
                            
                            <div className="text-zinc-400 font-medium">Tamanho</div>
                            <div className="text-right font-bold ">{product.tamanho}</div>
                            
                            <div className="text-zinc-400 font-medium">Altura da Alça</div>
                            <div className="text-right font-bold ">{product.alca}</div>
                        </div>
                    </div>
